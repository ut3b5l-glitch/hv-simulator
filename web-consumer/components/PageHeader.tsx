  ...
  if (hero) {
    return (
      <header className="hero-grad animate-fade-in overflow-hidden rounded-squircle p-5">
        ...
        <div className="mt-6">
          <div className="text-micro font-semibold uppercase tracking-eyebrow text-accent-yellow/80">
            {eyebrow}
          </div>
          <h1 className="mt-1.5 text-[2.35rem] font-medium leading-[1.04] tracking-tight text-mint">
            {title}
          </h1>
  ...
  return (
    <header className="animate-fade-in flex items-start justify-between gap-3">
      <div className="min-w-0">
        ...
        <h1 className="mt-1 text-display font-medium leading-none tracking-tight">{title}</h1>
