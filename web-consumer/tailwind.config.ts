  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Accents are themed too — Visual Design v1 values, tuned to stay
        // legible on smoked-glass surfaces over the charcoal backdrop.
        accent: {
        ...
        // Brand anchors — coal dark anchor + warm ivory (legacy names kept;
        // semantics hold: navy = dark anchor, mint = light-on-dark text).
      ...
      boxShadow: {
        ...
        // Black soft shadows suit the dark theme (the .glass CSS classes also
        // set token-driven shadows; these cover standalone use).
        "glass-1": "0 1px 2px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.14)",
        "glass-2":
          "0 8px 30px -6px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.18)",
        "glass-3":
          "0 18px 50px -10px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.24)",
        // Back-compat aliases used by existing markup.
        glass: "0 8px 30px -6px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.18)",
        glassHover:
          "0 18px 50px -10px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.24)",
        "glow-gold": "0 0 0 1px rgba(211,179,88,0.32), 0 6px 24px -6px rgba(211,179,88,0.32)",
        "glow-yellow":
          "0 0 0 1px rgba(249,239,152,0.3), 0 8px 28px -8px rgba(249,239,152,0.35)",
        "glow-green": "0 0 0 1px rgba(107,195,75,0.3), 0 6px 24px -8px rgba(107,195,75,0.3)",
        "glow-indigo": "0 12px 32px -10px rgba(0,0,0,0.55)",
      },
